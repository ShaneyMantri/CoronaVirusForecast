...
#rm(data_path, plot_path, csv_data_file, dat, model, forecast.df, last.t, latest.date, full_path, home, today, today.ch)

current_working_directory = getwd()
data_path = paste(current_working_directory,  "/data/", sep="")


#plot_path = paste(current_working_directory,  "/plots/", sep="")

csv_data_file = "CoronaVirusData.csv"
full_path = paste(data_path, csv_data_file, sep="")
...
file.copy(from=full_path, to=current_working_directory)
file.rename(from=file.path(current_working_directory, fnm), to=file.path(current_working_directory, "latest-prediction.png"))
